...
export const Footer = () => {
	...
	return (
		<footer className="pt-10 text-sm dark:border-neutral-800 dark:text-neutral-400 pl-2">
			...
			<p className="text-accent-1 font-interLight">You can reach me at <a href="" className="underline">jim.kollevik@gmail.com</a> or read <a href="../assetts/cv_eng_jimkollevik.pdf" className="underline" target="_blank">my cv here</a>.
