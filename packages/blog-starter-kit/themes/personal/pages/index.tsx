...
// Ny komponent för att hantera den slumpmässiga texten
function RandomTextSection() {
  const texts = ["Text 1", "Text 2", "Text 3"];
  const linkedTexts = ["Linked text 1", "Linked text 2", "Linked text 3"];

  const [currentText, setCurrentText] = useState("");
  const [currentLinkedText, setCurrentLinkedText] = useState("");

  useEffect(() => {
    const randomIndex = Math.floor(Math.random() * texts.length);
    setCurrentText(texts[randomIndex]);
    setCurrentLinkedText(linkedTexts[randomIndex]);
  }, []);
			...
			<Layout>
				...
				<Container className="mx-auto flex max-w-2xl flex-col items-stretch gap-10 px-5 py-10 pt-10 text-sm">
					...
					<div className="max-w-sm mb-12 font-interLight">
						...
						<br/><br/>
						When I&apos;m not doing that I&apos;m either in the slopes or in the kitchen cooking Italian food. Sometimes I finish a book but more often thinking of new ideas, technologies or code.
						<br/><br/>
						Get in touch: <a href="mailto:jim.kollevik@gmail.com" className="underline text-accent-1 text-sm dark:border-neutral-800 dark:text-neutral-400">jim.kollevik@gmail.com</a>
						</p>
					</div>
					...
					{/* Övriga sektioner, till exempel "Toolbox", "Testimonial", "Certifications" */}
					<div className="mb-12">
						<h2>Toolbox</h2>
						<br/>
